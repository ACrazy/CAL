            ...
            <li>
                <el-dropdown @command="handleCommand">
                    ...
                    <el-dropdown-menu slot="dropdown">
                        <el-dropdown-item command="a">{{ 123 }}</el-dropdown-item>
                        <el-dropdown-item command="b">{{ 321}}</el-dropdown-item>
                        <el-dropdown-item command="logout" divided>{{ 2131312 }}</el-dropdown-item>
                    </el-dropdown-menu>
                </el-dropdown>
            </li>
            <li class="icon">
